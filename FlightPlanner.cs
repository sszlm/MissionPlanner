...
namespace MissionPlanner.GCSViews
{
    public partial class FlightPlanner : MyUserControl, IDeactivate, IActivate
    {
        ...
        private void poieditToolStripMenuItem_Click(object sender, EventArgs e)//编辑兴趣点
        {
        ...
        private void poideleteToolStripMenuItem_Click(object sender, EventArgs e)//删除兴趣点
        {
            if (CurrentGMapMarker == null)
                return;
        ...
        private void poiaddToolStripMenuItem_Click(object sender, EventArgs e)//添加兴趣点
        {
        ...
        public void callMeDrag(string pointno, double lat, double lng, int alt)//调整拖曳的点
        {
            if (pointno == "")
            {
                return;
        ...
        /// <param name="lng"></param>
        /// <param name="alt"></param>
        public void setfromMap(double lat, double lng, int alt, double p1 = 0)//将经纬度高度等数值填入下方表格并核实高度
        {
        ...
        /// <param name="lng"></param>
        /// <param name="alt"></param>
        public void SetMouseDisplay(double lat, double lng, int alt)//显示当前鼠标所指位置信息
        {
        ...
        /// <param name="lng"></param>
        /// <param name="alt"></param>
        public void AddWPToMap(double lat, double lng, int alt)//添加新路径点
        {
            if (polygongridmode)
            {
        ...
        /// <param name="e"></param>
        private void BUT_Add_Click(object sender, EventArgs e)//在下方添加一条航线
        {
                ...
                if (TXT_homealt.Text != "" && TXT_homelat.Text != "" && TXT_homelng.Text != "")
                {
                    ...
                    if (objectsoverlay != null) // during startup
                    {
                        pointlist.Add(new PointLatLngAlt(double.Parse(TXT_homelat.Text), double.Parse(TXT_homelng.Text),
                            (int) double.Parse(TXT_homealt.Text), "H"));
                            ...
                            || command == (byte) MAVLink.MAV_CMD.DO_SET_ROI)
                        {
                            ...
                            if (command == (byte) MAVLink.MAV_CMD.DO_SET_ROI)
                            {
                                pointlist.Add(new PointLatLngAlt(double.Parse(cell3), double.Parse(cell4),
                                    (int) double.Parse(cell2) + homealt, "ROI" + (a + 1)) {color = Color.Red});
                            ...
                            {
                                pointlist.Add(new PointLatLngAlt(double.Parse(cell3), double.Parse(cell4),
                                    (int) double.Parse(cell2) + homealt, (a + 1).ToString())
                                {
                                    color = Color.LightBlue
                                });
                                fullpointlist.Add(pointlist[pointlist.Count - 1]);
                                addpolygonmarker((a + 1).ToString(), double.Parse(cell4), double.Parse(cell3),
                                    (int) double.Parse(cell2), Color.LightBlue);
                            }
                            else if (command == (byte) MAVLink.MAV_CMD.SPLINE_WAYPOINT)
                            {
                                pointlist.Add(new PointLatLngAlt(double.Parse(cell3), double.Parse(cell4),
                                    (int) double.Parse(cell2) + homealt, (a + 1).ToString()) {Tag2 = "spline"});
                                fullpointlist.Add(pointlist[pointlist.Count - 1]);
                                addpolygonmarker((a + 1).ToString(), double.Parse(cell4), double.Parse(cell3),
                                    (int) double.Parse(cell2), Color.Green);
                            }
                            else
                            {
                                pointlist.Add(new PointLatLngAlt(double.Parse(cell3), double.Parse(cell4),
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        internal void BUT_read_Click(object sender, EventArgs e)//读取航点
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void BUT_write_Click(object sender, EventArgs e)//写入航点
        {
            if ((altmode) CMB_altmode.SelectedValue == altmode.Absolute)
            {
                if (DialogResult.No ==
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Commands_CellContentClick(object sender, DataGridViewCellEventArgs e)//修改数据框的信息
        {
            try
            {
                if (e.RowIndex < 0)
        ...
        private void TXT_homelat_TextChanged(object sender, EventArgs e)//修改起始位置纬度
        {
            sethome = false;
            try
            {
        ...
        private void TXT_homelng_TextChanged(object sender, EventArgs e)//修改起始位置经度
        {
            sethome = false;
            try
            {
        ...
        private void TXT_homealt_TextChanged(object sender, EventArgs e)//修改起始位置高度
        {
            sethome = false;
            try
            {
        ...
        private void BUT_loadwpfile_Click(object sender, EventArgs e)//加载航点文件
        {
        ...
        */
        ...
        private void trackBar1_Scroll(object sender, EventArgs e)//地图比例大小
        {
            try
            {
                lock (thisLock)
        ...
        private void ContextMeasure_Click(object sender, EventArgs e)//地图工具测量距离
        {
        ...
        private void rotateMapToolStripMenuItem_Click(object sender, EventArgs e)//地图工具旋转地图
        {
            string heading = "0";
        ...
        private void addPolygonPointToolStripMenuItem_Click(object sender, EventArgs e)//绘制多边形，添加多边形点
        {
        ...
        private void clearPolygonToolStripMenuItem_Click(object sender, EventArgs e)//清除多边形
        {
        ...
        private void clearMissionToolStripMenuItem_Click(object sender, EventArgs e)//清除任务
        {
            quickadd = true;
        ...
        private void loiterForeverToolStripMenuItem_Click(object sender, EventArgs e)//留待模式永远
        {
            selectedrow = Commands.Rows.Add();
        ...
        private void jumpstartToolStripMenuItem_Click(object sender, EventArgs e)//跳转开始
        {
            string repeat = "5";
        ...
        private void jumpwPToolStripMenuItem_Click(object sender, EventArgs e)//航点编号跳转
        {
            string wp = "1";
        ...
        private void deleteWPToolStripMenuItem_Click(object sender, EventArgs e)//删除航点
        {
            int no = 0;
            if (CurentRectMarker != null)
            {
        ...
        private void loitertimeToolStripMenuItem_Click(object sender, EventArgs e)//留待模式按时间
        {
            string time = "5";
        ...
        private void loitercirclesToolStripMenuItem_Click(object sender, EventArgs e)//留待模式绕圈
        {
            string turns = "3";
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void timer1_Tick(object sender, EventArgs e)//时间工具
        {
            try
            {
                if (isMouseDown)
                ...
                {
                    routesoverlay.Markers.Add(new GMapMarkerRover(currentloc, MainV2.comPort.MAV.cs.yaw,
                        MainV2.comPort.MAV.cs.groundcourse, MainV2.comPort.MAV.cs.nav_bearing,
                        MainV2.comPort.MAV.cs.target_bearing));
                }
                else if (MainV2.comPort.MAV.aptype == MAVLink.MAV_TYPE.HELICOPTER)
                {
                    routesoverlay.Markers.Add(
                        (new GMapMarkerHeli(currentloc, MainV2.comPort.MAV.cs.yaw, MainV2.comPort.MAV.cs.groundcourse,
                            MainV2.comPort.MAV.cs.nav_bearing)));
                }
                ...
                {
                    routesoverlay.Markers.Add(new GMapMarkerQuad(currentloc, MainV2.comPort.MAV.cs.yaw,
                        MainV2.comPort.MAV.cs.groundcourse, MainV2.comPort.MAV.cs.nav_bearing, MainV2.comPort.MAV.sysid));
                }
        ...
        private void GeoFenceuploadToolStripMenuItem_Click(object sender, EventArgs e)//上传极限范围
        {
            polygongridmode = false;
            //FENCE_TOTAL
        ...
        private void GeoFencedownloadToolStripMenuItem_Click(object sender, EventArgs e)//下载极限范围
        {
            polygongridmode = false;
            int count = 1;
        ...
        private void setReturnLocationToolStripMenuItem_Click(object sender, EventArgs e)//设置返航点
        {
            geofenceoverlay.Markers.Clear();
        ...
        private void loadFromFileToolStripMenuItem_Click(object sender, EventArgs e)//打开极限范围的文件
        {
            using (OpenFileDialog fd = new OpenFileDialog())
            {
        ...
        private void saveToFileToolStripMenuItem_Click(object sender, EventArgs e)//保存极限范围的文件
        {
            if (geofenceoverlay.Markers.Count == 0)
            {
        ...
        private void createWpCircleToolStripMenuItem_Click(object sender, EventArgs e)//设置航点圈
        {
            string RadiusIn = "50";
        ...
        private void setROIToolStripMenuItem_Click(object sender, EventArgs e)//设置兴趣区域，机头相机指向
        {
        ...
        private void zoomToToolStripMenuItem_Click(object sender, EventArgs e)//地图工具将地图放大
        {
        ...
        private void prefetchToolStripMenuItem_Click(object sender, EventArgs e)//地图工具读取
        {
        ...
        private void kMLOverlayToolStripMenuItem_Click(object sender, EventArgs e)//KML覆盖
        {
            using (OpenFileDialog fd = new OpenFileDialog())
            {
        ...
        private void elevationGraphToolStripMenuItem_Click(object sender, EventArgs e)//地图工具高度曲线
        {
            writeKML();
        ...
        private void rTLToolStripMenuItem_Click(object sender, EventArgs e)//返航
        {
            selectedrow = Commands.Rows.Add();
        ...
        private void landToolStripMenuItem_Click(object sender, EventArgs e)//降落
        {
            selectedrow = Commands.Rows.Add();
        ...
        private void takeoffToolStripMenuItem_Click(object sender, EventArgs e)//起飞
        {
            // altitude
            string alt = "10";
        ...
        private void loadWPFileToolStripMenuItem_Click(object sender, EventArgs e)//加载航点文件
        {
            BUT_loadwpfile_Click(null, null);
        }

        private void saveWPFileToolStripMenuItem_Click(object sender, EventArgs e)//保存航点文件
        {
            SaveFile_Click(null, null);
        }

        private void trackerHomeToolStripMenuItem_Click(object sender, EventArgs e)//追踪器的家
        {
        ...
        private void reverseWPsToolStripMenuItem_Click(object sender, EventArgs e)//地图工具反转航点
        {
        ...
        private void loadAndAppendToolStripMenuItem_Click(object sender, EventArgs e)//下载与附加
        {
            using (OpenFileDialog fd = new OpenFileDialog())
            {
                fd.Filter = "Ardupilot Mission|*.waypoints;*.txt";
        ...
        private void savePolygonToolStripMenuItem_Click(object sender, EventArgs e)//保存多边形
        {
            if (drawnpolygon.Points.Count == 0)
            {
                return;
        ...
        private void loadPolygonToolStripMenuItem_Click(object sender, EventArgs e)//打开下载的多边形
        {
            using (OpenFileDialog fd = new OpenFileDialog())
            {
        ...
        private void areaToolStripMenuItem_Click(object sender, EventArgs e)//计算航点区域面积
        {
        ...
        private void chk_grid_CheckedChanged(object sender, EventArgs e)//网格
        {
            grid = chk_grid.Checked;
        }

        private void insertWpToolStripMenuItem_Click(object sender, EventArgs e)//插入航点
        {
        ...
        public void getRallyPointsToolStripMenuItem_Click(object sender, EventArgs e)//下载集结点
        {
        ...
        private void saveRallyPointsToolStripMenuItem_Click(object sender, EventArgs e)//上传集结点
        {
            byte count = 0;
        ...
        private void setRallyPointToolStripMenuItem_Click(object sender, EventArgs e)//设定集结点
        {
        ...
        private void clearRallyPointsToolStripMenuItem_Click(object sender, EventArgs e)//清除集结点
        {
            try
            {
        ...
        private void loadKMLFileToolStripMenuItem_Click(object sender, EventArgs e)//加载KML文件
        {
            using (OpenFileDialog fd = new OpenFileDialog())
            {
                fd.Filter = "Google Earth KML |*.kml;*.kmz";
        ...
        private void lnk_kml_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)//连接下载
        {
            try
            {
        ...
        private void modifyAltToolStripMenuItem_Click(object sender, EventArgs e)//修改高度
        {
            string altdif = "0";
        ...
        private void saveToFileToolStripMenuItem1_Click(object sender, EventArgs e)//保存集结点至文件
        {
...
Column 1: Field type (RALLY is the only one at the moment -- may have RALLY_LAND in the future)
 ...
 Column 7: Flags (just 0 for now, also future use).
        ...
        private void loadFromFileToolStripMenuItem1_Click(object sender, EventArgs e)//从文件中打开存储的集结点
        {
            using (OpenFileDialog fd = new OpenFileDialog())
            {
        ...
        private void prefetchWPPathToolStripMenuItem_Click(object sender, EventArgs e)//地图工具预读取航点路径
        {
            FetchPath();
        }
        ...
        private void enterUTMCoordToolStripMenuItem_Click(object sender, EventArgs e)//进入UTM坐标
        {
        ...
        private void loadSHPFileToolStripMenuItem_Click(object sender, EventArgs e)//加载SHP文件
        {
            using (OpenFileDialog fd = new OpenFileDialog())
            {
        ...
        private void BUT_saveWPFile_Click(object sender, EventArgs e)//保存航点文件
        {
            SaveFile_Click(null, null);
        }

        private void switchDockingToolStripMenuItem_Click(object sender, EventArgs e)//交换停靠菜单
        {
        ...
        private void insertSplineWPToolStripMenuItem_Click(object sender, EventArgs e)//插入曲线航点
        {
            string wpno = (selectedrow + 1).ToString("0");
            if (InputBox.Show("Insert WP", "Insert WP after wp#", ref wpno) == DialogResult.OK)
            {
        ...
        private void CHK_splinedefault_CheckedChanged(object sender, EventArgs e)//曲线
        {
            splinemode = CHK_splinedefault.Checked;
        }

        private void createSplineCircleToolStripMenuItem_Click(object sender, EventArgs e)//创建曲线圈
        {
            string RadiusIn = "50";
            if (DialogResult.Cancel == InputBox.Show("Radius", "Radius", ref RadiusIn))
                return;
        ...
        private void CMB_altmode_SelectedIndexChanged(object sender, EventArgs e)//修改高度类型
        {
        ...
        private void fromSHPToolStripMenuItem_Click(object sender, EventArgs e)//来自SHP
        {
            using (OpenFileDialog fd = new OpenFileDialog())
            {
                fd.Filter = "Shape file|*.shp";
        ...
        private void TXT_loiterrad_TextChanged(object sender, EventArgs e)
        {

        }

        private void TXT_DefaultAlt_TextChanged(object sender, EventArgs e)
        {
        ...
        private void LBL_defalutalt_Click(object sender, EventArgs e)
        {
