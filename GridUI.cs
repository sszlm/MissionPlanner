...
namespace MissionPlanner
{
    public partial class GridUI : Form
    {
        ...
        private void GridUI_Load(object sender, EventArgs e)//survey对话框
        {
        ...
        void loadgriddata(GridData griddata)//载入区域的数据
        {
            list = griddata.poly;
        ...
        void loadsetting(string key, Control item)//载入设置函数
        {
        ...
        // Do Work
        private void domainUpDown1_ValueChanged(object sender, EventArgs e)//simple和grid options的各项参数并进行计算
        {
        ...
        private void AddWP(double Lng, double Lat, double Alt)//添加路径点
        {
        ...
        string secondsToNice(double seconds)//计算时间
        {
            if (seconds < 0)
        ...
        double calcpolygonarea(List<PointLatLngAlt> polygon)//计算多边形面积
        {
        ...
        double getAngleOfLongestSide(List<PointLatLngAlt> list)//获得最长边角度
        {
            if (list.Count == 0)
                return 0;
            double angle = 0;
        ...
        private void CalcHeadingHold()//计算机头指向角度
        {
        ...
        private void map_MouseUp(object sender, MouseEventArgs e)//鼠标回弹
        {
        ...
        private void map_MouseDown(object sender, MouseEventArgs e)//鼠标按住的状态
        {
        ...
        private void map_MouseMove(object sender, MouseEventArgs e)//鼠标移动
        {
        ...
        private void map_OnMapZoomChanged()//地图比例变化
        {
            if (map.Zoom > 0)
            {
                try
        ...
        // Operators
        private void trackBar1_ValueChanged(object sender, EventArgs e)//地图比例大小通过数值变化
        {
            try
            {
                lock (thisLock)
        ...
        private void trackBar1_Scroll(object sender, EventArgs e)//地图比例大小通过滚轴变化
        {
            try
            {
                lock (thisLock)
        ...
        private void NUM_ValueChanged(object sender, EventArgs e)//航向重叠度与旁向重叠度，相机焦距
        {
            doCalc();
        }

        private void CMB_camera_SelectedIndexChanged(object sender, EventArgs e)//选择相机型号
        {
        ...
        private void TXT_TextChanged(object sender, EventArgs e)//相机像素和传感器参数
        {
            doCalc();
        }

        private void CHK_camdirection_CheckedChanged(object sender, EventArgs e)//单选框
        {
            doCalc();
        }
        ...
        private void CHK_copter_headinghold_CheckedChanged(object sender, EventArgs e)//机头方向固定
        {
            if (CHK_copter_headinghold.Checked)
            {
        ...
        private void CHK_copter_headingholdlock_CheckedChanged(object sender, EventArgs e)//解除机头角度角度限制
        {
        ...
        private void BUT_samplephoto_Click(object sender, EventArgs e)//载入存储的相机数据
        {
            using (OpenFileDialog ofd = new OpenFileDialog())
            {
                ofd.Filter = "*.jpg|*.jpg";
        ...
        private void BUT_save_Click(object sender, EventArgs e)//存储相机数据
        {
            camerainfo camera = new camerainfo();
        ...
        private void BUT_Accept_Click(object sender, EventArgs e)//确定生成摄影测量路径
        {
        ...
        private void CHK_usespeed_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void CHK_toandland_RTL_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void NUM_copter_delay_ValueChanged(object sender, EventArgs e)
        {
        ...
        private void LBL_copter_delay_Click(object sender, EventArgs e)
        {

        }

        private void groupBox_copter_Enter(object sender, EventArgs e)
        {
        ...
        private void LBL_Alternating_lanes_Click(object sender, EventArgs e)
        {
        ...
        private void LBL_Lane_Dist_Click(object sender, EventArgs e)
        {
        ...
        private void TXT_fovH_TextChanged(object sender, EventArgs e)
        {

        }

        private void TXT_fovV_TextChanged(object sender, EventArgs e)
        {
        ...
        private void rad_trigdist_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void chk_stopstart_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void rad_digicam_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void NUM_reptservo_ValueChanged(object sender, EventArgs e)
        {

        }

        private void num_reptpwm_ValueChanged(object sender, EventArgs e)
        {

        }

        private void NUM_repttime_ValueChanged(object sender, EventArgs e)
        {
